export const ProjectsMap = [{
    ...
    details: "This Project is a website design and implantation, first of all the Logo design was the first step, I used illustrator for this came up with a few ideas, and then the stakeholders selected their favorite pick.",
    details2: "Afterwards with the brand identity and logo created and finished, I started creating low-fi concepts for how the landing page would look like, then started to slowly transform these designs into high fidelity designs, adding custom UI elements and SVG animations and making sure to customize them to match the brand's color scheme and vision",
...
},
{
    ...
    details: "Weatherly is a premium weather application that focuses on creating a beautiful experience that has perfect UX to accompany the beautiful UI",
    details3: "This Project was started from the bottom up, starting with creating mood boards and a brand identity to go along with the premium and elegant look we had in mind, the logo then came along, I wanted the logo to be both elegant and simple, but most importantly memorable.",
    details4: "After making sure we had a clear vision on how to create and implement the visuals, we started to implement various UX methods to further understand our users and create a product that is centered around them. Numerous UX methods like interviews, research, and more were implemented, and that gave us a huge insight into creatin the perfect product for the user.",
    details2: "Last but not least, after we had gathered all our insights, created our goals and defined our objectives, I started creating lo-fi prototypes, that were then slowly but surely transferred into full blown working prototypes.",
    images: [{
...
},
{
    ...
    details: "JPadel is an Egyptian based company that focuses on renting out padel courts all over the nation through their mobile application, I worked at JPadel as both a UX/UI Designer and a Software Engineer. During this time, I was tasked with maintaining their newly created Flutter application and adding new features to it, while at the same time creating a whole redesign of the application.",
    details2: "Moreover I was also tasked with creating a landing page design, and a CMS design and implantation. I learned a lot during my time at the company and created multiple products that helped me become both a better designer and a developer.",
    details3: "Below is a summary of most of the work I created for JPadel, you can find their application Live on both the app and play store.",
    images: [{
...
},
{
    ...
    details2: "Creating the Xplore logo was a treat, the company wanted a bold creative logo that conveys their vision to their target audience, along with some good premium  looking mockups to inspire their users.",
    images: [{
...
},
{
    ...
    details: "The Project is a simple but elegant one, a few mockups, a great logo and some solid texts are the basis of this project, enjoy a slideshow below of the results.",
    images: [{
